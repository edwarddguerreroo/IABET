...
class XGBoostTRBTrainer:
    ...
    def generate_all_visualizations(self):
        ...
        fig.suptitle('Dashboard Completo - Modelo NBA TRB Prediction', fontsize=22, fontweight='bold', y=0.98)
    ...
    def _plot_correlation_analysis(self, ax):
        ...
        ax.set_ylabel('Correlación Absoluta con Rebounds', fontsize=11, fontweight='bold')
...
"""
    ...
    def save_results(self):
        ...
        if hasattr(self.model.stacking_model, 'feature_importance') and self.model.stacking_model.feature_importance:
            ...
            # Calcular correlación con el target (rebounds)
            logger.info("Calculando correlaciones con el target (rebounds)...")
            correlations = {}
